...
assimilation      = load("/Users/glmarschmann/.julia/dev/DEBmicroTrait/first_manuscript/files/isolates_assimilation.jld")
enzymes           = load("/Users/glmarschmann/.julia/dev/DEBmicroTrait/first_manuscript/files/isolates_enzymes.jld")
maintenance       = load("/Users/glmarschmann/.julia/dev/DEBmicroTrait/first_manuscript/files/isolates_maintenance.jld")
protein_synthesis = load("/Users/glmarschmann/.julia/dev/DEBmicroTrait/first_manuscript/files/isolates_protein_synthesis.jld")
turnover          = load("/Users/glmarschmann/.julia/dev/DEBmicroTrait/first_manuscript/files/isolates_turnover.jld")
initb             = load("/Users/glmarschmann/.julia/dev/DEBmicroTrait/first_manuscript/files/isolates_batch_init.jld")
...
CSV.write("/Users/glmarschmann/.julia/dev/DEBmicroTrait/first_manuscript/files_pub/isolates_pca.csv", df_pca)
...
CSV.write("/Users/glmarschmann/.julia/dev/DEBmicroTrait/first_manuscript/files_pub/isolates_batch_model_BGE.csv", df_out_bge)
...
CSV.write("/Users/glmarschmann/.julia/dev/DEBmicroTrait/final_manuscript/files/isolates_batch_model_train.csv", df_out_pn[:,2:15])
CSV.write("/Users/glmarschmann/.julia/dev/DEBmicroTrait/final_manuscript/files/isolates_batch_model_test.csv", df_out_u[:,2:15])
