...
function get_stoich_electron_acceptor_N()
    stoich_electron_acceptor = zeros(10)
    stoich_electron_acceptor[3] = 1  # nh4
    stoich_electron_acceptor[7] = +6  # h+
    stoich_electron_acceptor[8] = +5  # e-
    stoich_electron_acceptor[2] =  -3  # h2o
    return stoich_electron_acceptor
end
...
function get_stoich_catabolic_reaction_N(elementstring::String)
    stoich_electron_donor = get_stoich_electron_donor(elementstring)
    stoich_electron_acceptor = get_stoich_electron_acceptor_N()
    yEd = stoich_electron_donor[8]
    yEa = stoich_electron_acceptor[8]
    stoich_cat_rxns = stoich_electron_donor-(yEd/yEa)*stoich_electron_acceptor
    return stoich_cat_rxns
