...
functional_groups = vcat(repeat(["Aerobic heterotroph glucose"],size(df_aerob_hetero.genome,1)), repeat(["Aerobic heterotroph acetate"],size(df_aerob_hetero.genome,1)), repeat(["Fermenter"],size(df_ferm.genome,1)), repeat(["Acetotrophic methanogen"],size(df_am.genome,1)), repeat(["Acetotrophic methanogen"],size(df_am.genome,1)),
...
CSV.write("/Users/glmarschmann/Data/Zhen/TraitPredictionsIsogenieGenomes_GA.csv", df_out)
################################################################################
